...
- The mandatory seatbelt production law, as well as the mandatory seatbelt wearing law did have a statistically sigificant impact in reducing number of drivers, van drivers and front seat passengers killed. The laws slightly increased number of rear seat passengers killed, but not significantly so.
- There is no relationship between DriversKilled and any other variable in the dataset except number of drivers.
