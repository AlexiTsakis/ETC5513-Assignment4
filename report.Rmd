...
```{r season, echo = FALSE, message = FALSE, warning = FALSE}
 ggplot(data = Seatbelts) +
  geom_point(mapping = aes(x = Month, y = DriversKilled, col=Seatbelts$law + 2))-> G1

 ggplot(data = Seatbelts) +
  geom_point(mapping = aes(x = Month, y = front, col=Seatbelts$law + 2))-> G2
...
- based on the color plots, it can be seem that the number of driver deaths is the lowest after the front seatbelts legislation been introduced.